...
const designExamples = [
  {
    ...
    description:
      "Clean lines and open spaces define our modern prefab homes, perfect for contemporary living.",
    image:
  ...
  },
  {
    ...
    description:
      "Efficient workspaces designed for productivity and comfort in a minimalist aesthetic.",
    image:
  ...
  },
  {
    ...
    description:
      "Robust industrial structures engineered for heavy-duty operations and maximum efficiency.",
    image:
  ...
  },
  {
    ...
    description:
      "Transform shipping containers into luxurious living spaces with premium finishes.",
    image:
      "https://images.unsplash.com/photo-1632829882891-5047ccc421bc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    category: "Residential",
  ...
  },
  {
    ...
    description:
      "Modern commercial spaces designed to enhance customer experience and business operations.",
    image:
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-slate-200/40 to-slate-300/40 rounded-full blur-3xl transition-all duration-[2000ms] ${
            isVisible ? "translate-x-0 opacity-100" : "translate-x-24 opacity-0"
          }`}
        ></div>
        <div
          className={`absolute -bottom-32 -left-32 w-64 h-64 bg-gradient-to-tr from-slate-200/30 to-slate-400/30 rounded-full blur-3xl transition-all duration-[2500ms] delay-500 ${
            isVisible
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Explore our comprehensive portfolio of cutting-edge prefabricated
            construction solutions, spanning residential, commercial, and
        ...
        {/* Carousel Section */}
        <div
          className={`relative max-w-7xl mx-auto transition-all duration-1200 delay-400 ${
          ...
          <Carousel className="w-full" setApi={setApi}>
            <CarouselContent className="-ml-4">
              {designExamples.map((design, index) => (
                ...
                >
                  <Card
                    className={`group h-full border-0 bg-white shadow-sm hover:shadow-xl transition-all duration-700 overflow-hidden hover:-translate-y-1 ${
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-4"></p>
        </div>
      </div>
    </section>
  );
