        ...
        <div className="container relative z-10 h-full flex flex-col justify-end pb-16">
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              <Badge
                className={`${statusConfig[project.status as keyof typeof statusConfig]?.color} border backdrop-blur-sm font-medium px-4 py-2`}
              >
                {project.status}
              </Badge>
                    ...
                    <div className="relative mb-8">
                      <div className="aspect-[4/3] bg-slate-100 rounded-2xl overflow-hidden relative group">
                        <img
                          ...
                          alt={`${project.title} - Layout ${currentLayoutIndex + 1}`}
